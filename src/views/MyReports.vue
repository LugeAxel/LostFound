  ...
  <div class="min-h-screen bg-[#f8faf7] dark:bg-[#121212] flex font-sans pt-10">
    ...
    <main class="md:ml-64 pt-24 px-4 sm:px-6 md:px-8 pb-12 w-full max-w-[1200px] mx-auto">
      ...
      <div v-else class="grid grid-cols-1 gap-6">
        <div v-for="item in items" :key="item.id" class="bg-white dark:bg-[#1e1e1e] rounded-3xl p-4 md:p-6 border border-[#e0e4df] dark:border-[#374151] shadow-sm flex flex-col md:flex-row gap-4 md:gap-8 hover:shadow-md transition-all relative overflow-hidden">
