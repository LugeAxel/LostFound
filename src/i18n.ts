...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'dash.tutorial': 'Tutorial',
    'dash.tutorial_desc': 'New to the app? Learn how to report and claim items effectively.',
    'dash.start_tutorial': 'Start Tutorial',
    ...
    'profile.choose_platform': 'Choose platform...',
    'profile.wa_placeholder': 'Phone number (e.g. 628123456789)',
    'profile.social_placeholder': 'Username (without @)',
    'profile.download_qr': 'Download QR',
    'profile.print_qr': 'Print QR',
    'profile.save': 'Save Profile',
    'profile.saved': 'Profile saved successfully',
    'profile.qr_title': 'Your Profile QR',
    'profile.qr_desc': 'Print and stick this on your belongings. Anyone who scans it can view your contact info.',
    'profile.public_title': 'Scan Result',
    'profile.public_bio_empty': 'No bio yet.',
    'profile.public_contact': 'Contact',
    'profile.public_report_lost': 'Report a Lost Item',
    'profile.public_masked_wa': 'WhatsApp',
    'profile.username_taken': 'Username already taken',
    'profile.max_3_contacts': 'Maximum 3 contact links allowed',
    ...
    'developer.dev2_desc': 'Architects the Express.js and Supabase database.',
    'developer.dev3_name': 'Damarjati',
    'developer.dev3_role': 'UI/UX Designer',
    'developer.dev3_desc': 'Creates the user flow and modern aesthetics.',
    'developer.dev4_name': 'Adelia Dinda Damara',
    ...
    'myreports.subtitle': 'Manage the items you have reported.',
    'myreports.new_report': 'New Report',
    'myreports.all_areas': 'All Areas',
    'myreports.no_reports': 'No reports yet',
    'myreports.no_reports_desc': 'You haven\'t reported any items. All your reports will appear here.',
    'myreports.claim_qr_code': 'Claim QR Code',
    'myreports.claim_in_progress': 'CLAIM IN PROGRESS',
    'myreports.claim_qr_desc': 'Owner can scan this QR to confirm receipt.',
    'myreports.returned_successfully': 'Returned Successfully',
    'myreports.edit_item': 'Edit Item',
    'myreports.name': 'Name',
    'myreports.location': 'Location',
    'myreports.type': 'Type',
    'myreports.category': 'Category',
    'myreports.area_category': 'Area Category',
    'myreports.description': 'Description',
    'myreports.image': 'Image',
    'myreports.change_photo': 'Change Photo',
    'myreports.upload_photo': 'Upload Photo',
    'myreports.remove_photo': 'Remove Photo',
    'myreports.cancel': 'Cancel',
    'myreports.save_changes': 'Save Changes',
    'myreports.saving': 'Saving...',
    'myreports.select_area': 'Select area (optional)',
    'myreports.proof_of_return': 'Proof of Return',
    'myreports.verified_return': 'Verified Return',
    'myreports.handed_over': 'Handed over to owner.',
    'myreports.claimer': 'Claimer',
    'myreports.remove_claimer': 'Remove Claimer',
    'myreports.copied': 'Copied to clipboard',
    'myreports.no_claim_complaints': 'No complaints filed yet.',
    ...
    // === Report ===
    'report.back_to_dashboard': 'Back to Dashboard',
    'report.title': 'Create Report',
    'report.subtitle': 'Help the community find their belongings.',
    'report.found': 'Found',
    'report.lost': 'Lost',
    ...
    'report.item_name_placeholder': 'e.g. Blue Hydroflask, MacBook Air',
    'report.location': 'Location *',
    'report.location_placeholder': 'e.g. Lab 3, Library',
    'report.use_live_location': 'Use Live Location',
    'report.getting_location': 'Getting location...',
    'report.coordinates_attached': 'Coordinates attached',
    'report.clear_pin': 'Clear pin',
    'report.category': 'Category',
    'report.description': 'Description',
    'report.description_placeholder': 'Color, brand, or other identifying features...',
  ...
  id: {
    ...
    'dash.tutorial': 'Tutorial',
    'dash.tutorial_desc': 'Baru di aplikasi? Pelajari cara melaporkan dan mengklaim barang dengan efektif.',
    'dash.start_tutorial': 'Mulai Tutorial',
    ...
    'profile.bio': 'Bio',
    'profile.contact': 'Tautan Kontak',
    'profile.add_contact': 'Tambah Kontak',
    'profile.choose_platform': 'Pilih platform...',
    'profile.wa_placeholder': 'Nomor telepon (contoh: 628123456789)',
    'profile.social_placeholder': 'Nama pengguna (tanpa @)',
    'profile.download_qr': 'Unduh QR',
    'profile.print_qr': 'Cetak QR',
    'profile.save': 'Simpan Profil',
    'profile.saved': 'Profil berhasil disimpan',
    'profile.qr_title': 'QR Profil Anda',
    'profile.qr_desc': 'Cetak dan tempelkan QR ini pada barang-barang Anda. Siapa pun yang memindainya dapat melihat kontak Anda.',
    'profile.public_title': 'Hasil Pindai',
    'profile.public_bio_empty': 'Belum ada bio.',
    'profile.public_contact': 'Kontak',
    'profile.public_report_lost': 'Laporkan Barang Hilang',
    'profile.public_masked_wa': 'WhatsApp',
    'profile.username_taken': 'Nama pengguna sudah digunakan',
    'profile.max_3_contacts': 'Maksimal 3 tautan kontak diperbolehkan',
    ...
    'developer.dev2_name': 'Ahmad Lutfi Al Muzakir',
    'developer.dev2_role': 'Backend Engineer',
    'developer.dev2_desc': 'Merancang database Express.js dan Supabase.',
    'developer.dev3_name': 'Damarjati',
    'developer.dev3_role': 'UI/UX Designer',
    ...
    // === My Reports (suggestions) ===
    'myreports.title': 'Laporanku',
    'myreports.subtitle': 'Kelola barang yang telah kamu laporkan.',
    'myreports.new_report': 'Laporan Baru',
    'myreports.all_areas': 'Semua Area',
    'myreports.no_reports': 'Belum ada laporan',
    'myreports.no_reports_desc': 'Kamu belum melaporkan barang apapun. Semua laporan akan muncul di sini.',
    'myreports.claim_qr_code': 'QR Code Klaim',
    'myreports.claim_in_progress': 'KLAIM DALAM PROSES',
    'myreports.claim_qr_desc': 'Pemilik dapat memindai QR ini untuk konfirmasi penerimaan.',
    'myreports.returned_successfully': 'Berhasil Dikembalikan',
    'myreports.edit_item': 'Edit Barang',
    'myreports.name': 'Nama',
    'myreports.location': 'Lokasi',
    'myreports.type': 'Tipe',
    'myreports.category': 'Kategori',
    'myreports.area_category': 'Kategori Area',
    'myreports.description': 'Deskripsi',
    'myreports.image': 'Gambar',
    'myreports.change_photo': 'Ganti Foto',
    'myreports.upload_photo': 'Unggah Foto',
    'myreports.remove_photo': 'Hapus Foto',
    'myreports.cancel': 'Batal',
    'myreports.save_changes': 'Simpan Perubahan',
    'myreports.saving': 'Menyimpan...',
    'myreports.select_area': 'Pilih area (opsional)',
    'myreports.proof_of_return': 'Bukti Pengembalian',
    'myreports.verified_return': 'Verifikasi Dikembalikan',
    'myreports.handed_over': 'Diserahkan kepada pemilik.',
    'myreports.claimer': 'Pengklaim',
    'myreports.remove_claimer': 'Hapus Pengklaim',
    'myreports.copied': 'Disalin ke clipboard',
    'myreports.no_claim_complaints': 'Belum ada komplain.',
    ...
    // === Report ===
    'report.back_to_dashboard': 'Kembali ke Beranda',
    'report.title': 'Buat Laporan',
    'report.subtitle': 'Bantu komunitas menemukan barang mereka.',
    'report.found': 'Ditemukan',
    'report.lost': 'Hilang',
    'report.photos': 'Foto',
    'report.camera': 'Kamera',
    'report.upload': 'Unggah',
    'report.item_name': 'Nama Barang *',
    'report.item_name_placeholder': 'Contoh: Botol Biru, MacBook Air',
    'report.location': 'Lokasi *',
    'report.location_placeholder': 'Contoh: Lab 3, Perpustakaan',
    'report.use_live_location': 'Gunakan Lokasi Langsung',
    'report.getting_location': 'Mendapatkan lokasi...',
    'report.coordinates_attached': 'Koordinat terpasang',
    'report.clear_pin': 'Hapus pin',
    'report.category': 'Kategori',
    'report.description': 'Deskripsi',
    'report.description_placeholder': 'Warna, merek, atau ciri khas lainnya...',
