...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'dash.recommendations': 'Recommendations for You',
    'dash.recommendations_sub': 'Items that may match your reports',
    'dash.no_recommendations': 'No recommendations yet. Start by reporting items!',

    // === Onboarding ===
    'onboarding.skip': 'Skip',
    'onboarding.p0_title': 'Choose Your Language',
    'onboarding.p0_en': 'English',
  ...
  id: {
    ...
    'dash.recommendations': 'Rekomendasi untukmu',
    'dash.recommendations_sub': 'Barang yang mungkin cocok dengan laporanmu',
    'dash.no_recommendations': 'Belum ada rekomendasi. Mulai dengan melaporkan barang!',

    // === Onboarding (ID) ===
    'onboarding.skip': 'Lewati',
    'onboarding.p0_title': 'Pilih Bahasa',
    'onboarding.p0_en': 'English',
    'onboarding.p0_id': 'Bahasa Indonesia',
    'onboarding.p1_title': 'Kehilangan sesuatu? Tenang, kami bantu.',
    'onboarding.p1_desc': 'QReturn adalah sistem lost and found pintar SMKN 2 Depok, dirancang untuk menghubungkan kamu dengan barang berhargamu. Tanpa ribet, tanpa menunggu. Cukup foto, deskripsi, dan kami urus sisanya.',
    'onboarding.p1_cta': 'Lihat Caranya',
    ...
    'detail.last_seen': 'Terakhir:',
    'detail.found_at': 'Ditemukan:',
