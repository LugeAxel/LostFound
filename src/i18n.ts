...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'scanner.manual_label': 'QR Code ID',
    'scanner.manual_placeholder': 'Paste or type QR code ID...',
  ...
  id: {
    ...
    'scanner.manual_label': 'ID Kode QR',
    'scanner.manual_placeholder': 'Tempel atau ketik ID kode QR...',
